...
public class MyGraph<T> {
  ...
  public MyGraphNode<T> findVertexBreadthFirst(MyGraphNode<T> starterVertex, T valueToFind)
  ...
  private MyGraphNode<T> findVertexWithTargetNeighbor(MyGraphNode<T> targetNode, Stack<MyGraphEdge<T>> trackingStack) {
    // find vertex with target vertex as a neighbor and return the edge between them
    // else null
